...
- [Canonical SKILL.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/a-clarify-project-request/SKILL.md)
- [Skill directory](https://github.com/ecarrenolozano/ai-sdlc-skills/tree/main/skills/a-clarify-project-request)
...
Source: [references/process_flowchart.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/a-clarify-project-request/references/process_flowchart.md)
...
- [references/clarified-project-request-template.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/a-clarify-project-request/references/clarified-project-request-template.md)
- [references/golden-example/README.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/a-clarify-project-request/references/golden-example/README.md)
- [references/golden-example/in-informal-project-request.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/a-clarify-project-request/references/golden-example/in-informal-project-request.md)
- [references/golden-example/out-clarified-project-request.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/a-clarify-project-request/references/golden-example/out-clarified-project-request.md)
- [references/inception-readme-template.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/a-clarify-project-request/references/inception-readme-template.md)
- [references/process-flowchart.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/a-clarify-project-request/references/process-flowchart.md)
- [references/process_flowchart.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/a-clarify-project-request/references/process_flowchart.md)
- [references/sources-readme-template.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/a-clarify-project-request/references/sources-readme-template.md)

## Agent Configuration

- [agents/openai.yaml](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/a-clarify-project-request/agents/openai.yaml)
