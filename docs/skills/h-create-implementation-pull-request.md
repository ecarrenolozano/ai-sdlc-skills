...
- [Canonical SKILL.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/h-create-implementation-pull-request/SKILL.md)
- [Skill directory](https://github.com/ecarrenolozano/ai-sdlc-skills/tree/main/skills/h-create-implementation-pull-request)
...
Source: [references/process_flowchart.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/h-create-implementation-pull-request/references/process_flowchart.md)
...
- [scripts/inspect_pr_readiness.py](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/h-create-implementation-pull-request/scripts/inspect_pr_readiness.py)
- [scripts/run_regression_tests.py](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/h-create-implementation-pull-request/scripts/run_regression_tests.py)

## Reference Material

- [references/golden-example/README.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/h-create-implementation-pull-request/references/golden-example/README.md)
- [references/pr-policy.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/h-create-implementation-pull-request/references/pr-policy.md)
- [references/process_flowchart.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/h-create-implementation-pull-request/references/process_flowchart.md)
- [references/proposal-and-result-patterns.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/h-create-implementation-pull-request/references/proposal-and-result-patterns.md)

## Agent Configuration

- [agents/openai.yaml](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/h-create-implementation-pull-request/agents/openai.yaml)
