...
- [Canonical SKILL.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/j-prepare-release-deployment/SKILL.md)
- [Skill directory](https://github.com/ecarrenolozano/ai-sdlc-skills/tree/main/skills/j-prepare-release-deployment)
...
Source: [references/process_flowchart.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/j-prepare-release-deployment/references/process_flowchart.md)
...
- [scripts/validate_release_preparation.py](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/j-prepare-release-deployment/scripts/validate_release_preparation.py)

## Reference Material

- [references/golden-example/README.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/j-prepare-release-deployment/references/golden-example/README.md)
- [references/golden-example/browser-task-board/README.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/j-prepare-release-deployment/references/golden-example/browser-task-board/README.md)
- [references/golden-example/browser-task-board/in-repository/README.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/j-prepare-release-deployment/references/golden-example/browser-task-board/in-repository/README.md)
- [references/golden-example/browser-task-board/in-repository/pyproject.toml](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/j-prepare-release-deployment/references/golden-example/browser-task-board/in-repository/pyproject.toml)
- [references/golden-example/browser-task-board/in-repository/sdlc_docs/trace_workflow.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/j-prepare-release-deployment/references/golden-example/browser-task-board/in-repository/sdlc_docs/trace_workflow.md)
- [references/golden-example/browser-task-board/in-repository/uv.lock](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/j-prepare-release-deployment/references/golden-example/browser-task-board/in-repository/uv.lock)
- [references/golden-example/browser-task-board/in-trace_workflow.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/j-prepare-release-deployment/references/golden-example/browser-task-board/in-trace_workflow.md)
- [references/golden-example/browser-task-board/out-repository/Containerfile](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/j-prepare-release-deployment/references/golden-example/browser-task-board/out-repository/Containerfile)
- [references/golden-example/browser-task-board/out-repository/docs/release.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/j-prepare-release-deployment/references/golden-example/browser-task-board/out-repository/docs/release.md)
- [references/golden-example/browser-task-board/out-repository/pyproject.toml](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/j-prepare-release-deployment/references/golden-example/browser-task-board/out-repository/pyproject.toml)
- [references/golden-example/browser-task-board/out-repository/sdlc_docs/trace_workflow.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/j-prepare-release-deployment/references/golden-example/browser-task-board/out-repository/sdlc_docs/trace_workflow.md)
- [references/golden-example/browser-task-board/out-repository/uv.lock](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/j-prepare-release-deployment/references/golden-example/browser-task-board/out-repository/uv.lock)
- [references/golden-example/browser-task-board/out-trace_workflow.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/j-prepare-release-deployment/references/golden-example/browser-task-board/out-trace_workflow.md)
- [references/golden-example/browser-task-board/proposal.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/j-prepare-release-deployment/references/golden-example/browser-task-board/proposal.md)
- [references/golden-example/browser-task-board/release-preparation-execution.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/j-prepare-release-deployment/references/golden-example/browser-task-board/release-preparation-execution.md)
- [references/golden-example/browser-task-board/release-readiness-inspection.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/j-prepare-release-deployment/references/golden-example/browser-task-board/release-readiness-inspection.md)
- [references/golden-example/browser-task-board/result.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/j-prepare-release-deployment/references/golden-example/browser-task-board/result.md)
- [references/process_flowchart.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/j-prepare-release-deployment/references/process_flowchart.md)
- [references/release-deployment-policy.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/j-prepare-release-deployment/references/release-deployment-policy.md)

## Agent Configuration

- [agents/openai.yaml](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/j-prepare-release-deployment/agents/openai.yaml)
