...
- [Canonical SKILL.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/sdlc-orchestrate-workflow/SKILL.md)
- [Skill directory](https://github.com/ecarrenolozano/ai-sdlc-skills/tree/main/skills/sdlc-orchestrate-workflow)
...
Source: [references/process_flowchart.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/sdlc-orchestrate-workflow/references/process_flowchart.md)
...
- [scripts/test_validate_workflow_trace.py](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/sdlc-orchestrate-workflow/scripts/test_validate_workflow_trace.py)
- [scripts/validate_workflow_trace.py](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/sdlc-orchestrate-workflow/scripts/validate_workflow_trace.py)

## Reference Material

- [references/golden-example/README.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/sdlc-orchestrate-workflow/references/golden-example/README.md)
- [references/golden-example/browser-task-board/README.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/sdlc-orchestrate-workflow/references/golden-example/browser-task-board/README.md)
- [references/golden-example/browser-task-board/blocked-gate-examples.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/sdlc-orchestrate-workflow/references/golden-example/browser-task-board/blocked-gate-examples.md)
- [references/golden-example/browser-task-board/recommendation-examples.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/sdlc-orchestrate-workflow/references/golden-example/browser-task-board/recommendation-examples.md)
- [references/golden-example/browser-task-board/trace-repair-proposal.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/sdlc-orchestrate-workflow/references/golden-example/browser-task-board/trace-repair-proposal.md)
- [references/golden-example/browser-task-board/workflow-snapshot-after-foundation.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/sdlc-orchestrate-workflow/references/golden-example/browser-task-board/workflow-snapshot-after-foundation.md)
- [references/golden-example/browser-task-board/workflow-snapshot-after-implementation.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/sdlc-orchestrate-workflow/references/golden-example/browser-task-board/workflow-snapshot-after-implementation.md)
- [references/golden-example/browser-task-board/workflow-snapshot-early.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/sdlc-orchestrate-workflow/references/golden-example/browser-task-board/workflow-snapshot-early.md)
- [references/golden-example/browser-task-board/workflow-snapshot-missing-validation-row.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/sdlc-orchestrate-workflow/references/golden-example/browser-task-board/workflow-snapshot-missing-validation-row.md)
- [references/process_flowchart.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/sdlc-orchestrate-workflow/references/process_flowchart.md)
- [references/workflow-routing-policy.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/sdlc-orchestrate-workflow/references/workflow-routing-policy.md)

## Agent Configuration

- [agents/openai.yaml](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/sdlc-orchestrate-workflow/agents/openai.yaml)
