...
- [Canonical SKILL.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/c-manage-product-requirements/SKILL.md)
- [Skill directory](https://github.com/ecarrenolozano/ai-sdlc-skills/tree/main/skills/c-manage-product-requirements)
...
Source: [references/process_flowchart.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/c-manage-product-requirements/references/process_flowchart.md)
...
- [scripts/run_regression_tests.py](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/c-manage-product-requirements/scripts/run_regression_tests.py)
- [scripts/validate_scope_coverage.py](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/c-manage-product-requirements/scripts/validate_scope_coverage.py)
- [scripts/validate_trace_mutation.py](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/c-manage-product-requirements/scripts/validate_trace_mutation.py)
- [scripts/validate_workflow_alignment.py](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/c-manage-product-requirements/scripts/validate_workflow_alignment.py)

## Reference Material

- [references/golden-example/README.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/c-manage-product-requirements/references/golden-example/README.md)
- [references/golden-example/increment-broad-issue/in-product-requirements.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/c-manage-product-requirements/references/golden-example/increment-broad-issue/in-product-requirements.md)
- [references/golden-example/increment-broad-issue/in-trace_workflow.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/c-manage-product-requirements/references/golden-example/increment-broad-issue/in-trace_workflow.md)
- [references/golden-example/increment-broad-issue/in-triaged-issue.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/c-manage-product-requirements/references/golden-example/increment-broad-issue/in-triaged-issue.md)
- [references/golden-example/increment-broad-issue/out-product-requirements.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/c-manage-product-requirements/references/golden-example/increment-broad-issue/out-product-requirements.md)
- [references/golden-example/increment-broad-issue/out-trace_workflow.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/c-manage-product-requirements/references/golden-example/increment-broad-issue/out-trace_workflow.md)
- [references/golden-example/increment-user-story/in-product-requirements.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/c-manage-product-requirements/references/golden-example/increment-user-story/in-product-requirements.md)
- [references/golden-example/increment-user-story/in-trace_workflow.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/c-manage-product-requirements/references/golden-example/increment-user-story/in-trace_workflow.md)
- [references/golden-example/increment-user-story/in-triaged-issue.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/c-manage-product-requirements/references/golden-example/increment-user-story/in-triaged-issue.md)
- [references/golden-example/increment-user-story/out-product-requirements.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/c-manage-product-requirements/references/golden-example/increment-user-story/out-product-requirements.md)
- [references/golden-example/increment-user-story/out-trace_workflow.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/c-manage-product-requirements/references/golden-example/increment-user-story/out-trace_workflow.md)
- [references/golden-example/initial-release/in-project-context.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/c-manage-product-requirements/references/golden-example/initial-release/in-project-context.md)
- [references/golden-example/initial-release/in-refinement-answers.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/c-manage-product-requirements/references/golden-example/initial-release/in-refinement-answers.md)
- [references/golden-example/initial-release/in-trace_workflow.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/c-manage-product-requirements/references/golden-example/initial-release/in-trace_workflow.md)
- [references/golden-example/initial-release/out-product-requirements.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/c-manage-product-requirements/references/golden-example/initial-release/out-product-requirements.md)
- [references/golden-example/initial-release/out-trace_workflow.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/c-manage-product-requirements/references/golden-example/initial-release/out-trace_workflow.md)
- [references/golden-example/initial-release-umbrella/in-project-context.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/c-manage-product-requirements/references/golden-example/initial-release-umbrella/in-project-context.md)
- [references/golden-example/initial-release-umbrella/out-product-requirements-under-clarification.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/c-manage-product-requirements/references/golden-example/initial-release-umbrella/out-product-requirements-under-clarification.md)
- [references/process-flowchart.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/c-manage-product-requirements/references/process-flowchart.md)
- [references/process_flowchart.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/c-manage-product-requirements/references/process_flowchart.md)
- [references/product-requirements-template.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/c-manage-product-requirements/references/product-requirements-template.md)
- [references/test-fixtures/invalid-observed-umbrella-draft.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/c-manage-product-requirements/references/test-fixtures/invalid-observed-umbrella-draft.md)

## Agent Configuration

- [agents/openai.yaml](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/c-manage-product-requirements/agents/openai.yaml)
