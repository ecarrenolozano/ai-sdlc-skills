...
- [Canonical SKILL.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/g-implement-repository-work/SKILL.md)
- [Skill directory](https://github.com/ecarrenolozano/ai-sdlc-skills/tree/main/skills/g-implement-repository-work)
...
Source: [references/process_flowchart.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/g-implement-repository-work/references/process_flowchart.md)
...
- [scripts/inspect_implementation_readiness.py](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/g-implement-repository-work/scripts/inspect_implementation_readiness.py)
- [scripts/run_regression_tests.py](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/g-implement-repository-work/scripts/run_regression_tests.py)
- [scripts/validate_implementation_result.py](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/g-implement-repository-work/scripts/validate_implementation_result.py)

## Reference Material

- [references/backlog-priority-policy.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/g-implement-repository-work/references/backlog-priority-policy.md)
- [references/best-practices/README.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/g-implement-repository-work/references/best-practices/README.md)
- [references/best-practices/python-best-practices.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/g-implement-repository-work/references/best-practices/python-best-practices.md)
- [references/code-design-policy.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/g-implement-repository-work/references/code-design-policy.md)
- [references/completion-gates.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/g-implement-repository-work/references/completion-gates.md)
- [references/golden-example/README.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/g-implement-repository-work/references/golden-example/README.md)
- [references/golden-example/browser-task-board/README.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/g-implement-repository-work/references/golden-example/browser-task-board/README.md)
- [references/golden-example/browser-task-board/backlog_priority.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/g-implement-repository-work/references/golden-example/browser-task-board/backlog_priority.md)
- [references/golden-example/browser-task-board/code-level.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/g-implement-repository-work/references/golden-example/browser-task-board/code-level.md)
- [references/golden-example/browser-task-board/proposal.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/g-implement-repository-work/references/golden-example/browser-task-board/proposal.md)
- [references/golden-example/browser-task-board/result.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/g-implement-repository-work/references/golden-example/browser-task-board/result.md)
- [references/golden-example/browser-task-board/selected-issue.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/g-implement-repository-work/references/golden-example/browser-task-board/selected-issue.md)
- [references/golden-example/browser-task-board/tdd-execution.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/g-implement-repository-work/references/golden-example/browser-task-board/tdd-execution.md)
- [references/implementation-rules.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/g-implement-repository-work/references/implementation-rules.md)
- [references/process-flowchart.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/g-implement-repository-work/references/process-flowchart.md)
- [references/process_flowchart.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/g-implement-repository-work/references/process_flowchart.md)
- [references/proposal-and-result-patterns.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/g-implement-repository-work/references/proposal-and-result-patterns.md)
- [references/tdd-policy.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/g-implement-repository-work/references/tdd-policy.md)
- [references/test-placement.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/g-implement-repository-work/references/test-placement.md)

## Agent Configuration

- [agents/openai.yaml](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/g-implement-repository-work/agents/openai.yaml)

## Assets

- [assets/integration_test_template.py](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/g-implement-repository-work/assets/integration_test_template.py)
- [assets/regression_test_template.py](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/g-implement-repository-work/assets/regression_test_template.py)
- [assets/unit_test_template.py](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/g-implement-repository-work/assets/unit_test_template.py)
