...
- [Canonical SKILL.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/create-github-project-board/SKILL.md)
- [Skill directory](https://github.com/ecarrenolozano/ai-sdlc-skills/tree/main/skills/create-github-project-board)
...
No process flowchart file was found for this skill.

## Validation Scripts

- [scripts/validate_skill_policy.py](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/create-github-project-board/scripts/validate_skill_policy.py)
...
- [agents/openai.yaml](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/create-github-project-board/agents/openai.yaml)
