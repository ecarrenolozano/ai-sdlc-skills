...
- [Canonical SKILL.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/b-form-project-context/SKILL.md)
- [Skill directory](https://github.com/ecarrenolozano/ai-sdlc-skills/tree/main/skills/b-form-project-context)
...
Source: [references/process_flowchart.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/b-form-project-context/references/process_flowchart.md)
...
- [scripts/validate_trace_mutation.py](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/b-form-project-context/scripts/validate_trace_mutation.py)
- [scripts/validate_workflow_alignment.py](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/b-form-project-context/scripts/validate_workflow_alignment.py)

## Reference Material

- [references/golden-example/README.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/b-form-project-context/references/golden-example/README.md)
- [references/golden-example/in-approved-clarified-project-request.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/b-form-project-context/references/golden-example/in-approved-clarified-project-request.md)
- [references/golden-example/out-approved-project-context.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/b-form-project-context/references/golden-example/out-approved-project-context.md)
- [references/process-flowchart.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/b-form-project-context/references/process-flowchart.md)
- [references/process_flowchart.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/b-form-project-context/references/process_flowchart.md)
- [references/project-context-template.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/b-form-project-context/references/project-context-template.md)

## Agent Configuration

- [agents/openai.yaml](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/b-form-project-context/agents/openai.yaml)
