...
- [Canonical SKILL.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/e-sync-repository-requirements/SKILL.md)
- [Skill directory](https://github.com/ecarrenolozano/ai-sdlc-skills/tree/main/skills/e-sync-repository-requirements)
...
Source: [references/process_flowchart.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/e-sync-repository-requirements/references/process_flowchart.md)
...
- [scripts/validate_skill_policy.py](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/e-sync-repository-requirements/scripts/validate_skill_policy.py)

## Reference Material

- [references/decision-rules.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/e-sync-repository-requirements/references/decision-rules.md)
- [references/golden-example/README.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/e-sync-repository-requirements/references/golden-example/README.md)
- [references/issue-content-patterns.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/e-sync-repository-requirements/references/issue-content-patterns.md)
- [references/process_flowchart.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/e-sync-repository-requirements/references/process_flowchart.md)
- [references/proposal-and-result-patterns.md](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/e-sync-repository-requirements/references/proposal-and-result-patterns.md)

## Agent Configuration

- [agents/openai.yaml](https://github.com/ecarrenolozano/ai-sdlc-skills/blob/main/skills/e-sync-repository-requirements/agents/openai.yaml)
